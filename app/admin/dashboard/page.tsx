...
import { mockDashboardStats, mockEvents, mockReservations } from '../../../src/app/mockData';
            ...
            {activeEvents.length === 0 ? (
              ...
              <div className="space-y-3">
                {activeEvents.map((event) => (
                  <div key={event.id} onClick={() => router.push('/admin/events')}
            ...
            {recentReservations.length === 0 ? (
              ...
              <div className="space-y-3">
                {recentReservations.map((reservation) => (
                  <div key={reservation.id} onClick={() => router.push('/admin/reservations')}
                    className="p-4 border-2 border-[var(--brand-dark)]/10 hover:border-[var(--brand-dark)] transition-colors cursor-pointer">
