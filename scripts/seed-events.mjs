...
const events = [
  {
    ...
    dates: JSON.stringify(['2026-10-12', '2026-10-13', '2026-10-14']),
    start_time: '10:00',
    end_time: '18:00',
    ...
    vendor_categories: JSON.stringify([
  ...
  },
  {
    ...
    dates: JSON.stringify(['2026-10-20', '2026-10-21', '2026-10-22']),
    start_time: '10:00',
    end_time: '18:00',
    time_slots: JSON.stringify([
  ...
  },
  {
    ...
    dates: JSON.stringify(['2026-11-05', '2026-11-06', '2026-11-07']),
    start_time: '10:00',
    end_time: '17:00',
    time_slots: JSON.stringify([
      { id: 't1', time: '10:00' }, { id: 't2', time: '11:00' }, { id: 't3', time: '13:00' },
  ...
  },
  {
    ...
    dates: JSON.stringify(['2026-11-15', '2026-11-16']),
    start_time: '10:00',
    end_time: '18:00',
    time_slots: JSON.stringify([
  ...
  },
  {
    ...
    dates: JSON.stringify(['2026-11-25', '2026-11-26', '2026-11-27']),
    start_time: '10:00',
    end_time: '18:00',
    time_slots: JSON.stringify([
      { id: 't1', time: '10:00' }, { id: 't2', time: '11:30' }, { id: 't3', time: '13:00' },
  ...
  for (const e of events) {
    await db.execute({
      sql: `INSERT OR IGNORE INTO events
        ...
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
      args: [
        e.id, e.slug, e.title, e.description, e.venue, e.address, e.image_url,
        e.dates, e.start_time, e.end_time,
        e.time_slots, e.custom_fields, e.vendor_categories, e.vendors, e.status, e.created_at,
      ],
    })
    console.log(`✅ ${e.title}`)
  }
